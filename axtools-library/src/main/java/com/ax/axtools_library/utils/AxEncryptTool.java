...
public class AxEncryptTool {
    ...
    public static byte[] encryptDES2Base64(byte[] data, byte[] key) {
        return AxEncodeTool.base64Encode(encryptDES(data, key));
    }
    ...
    public static byte[] decryptBase64DES(byte[] data, byte[] key) {
        return decryptDES(AxEncodeTool.base64Decode(data), key);
    }
    ...
    public static byte[] encrypt3DES2Base64(byte[] data, byte[] key) {
        return AxEncodeTool.base64Encode(encrypt3DES(data, key));
    }
    ...
    public static byte[] decryptBase64_3DES(byte[] data, byte[] key) {
        return decrypt3DES(AxEncodeTool.base64Decode(data), key);
    }
    ...
    public static byte[] encryptAES2Base64(byte[] data, byte[] key) {
        return AxEncodeTool.base64Encode(encryptAES(data, key));
    }
    ...
    public static byte[] decryptBase64AES(byte[] data, byte[] key) {
        return decryptAES(AxEncodeTool.base64Decode(data), key);
    }
