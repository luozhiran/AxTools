...
public class AxConvertTool {
     ...
     * @param byteNum 字节数
     * @param unit    <ul>
     *                <li>{@link AxConstTool.MemoryUnit#BYTE}: 字节</li>
     *                <li>{@link AxConstTool.MemoryUnit#KB}  : 千字节</li>
     *                <li>{@link AxConstTool.MemoryUnit#MB}  : 兆</li>
     *                <li>{@link AxConstTool.MemoryUnit#GB}  : GB</li>
     *                </ul>
     * @return 以unit为单位的size
     */
    public static double byte2Size(long byteNum, AxConstTool.MemoryUnit unit) {
        if (byteNum < 0) {
            return -1;
        }
        switch (unit) {
            default:
            case BYTE:
                return (double) byteNum / AxConstTool.BYTE;
            case KB:
                return (double) byteNum / AxConstTool.KB;
            case MB:
                return (double) byteNum / AxConstTool.MB;
            case GB:
                return (double) byteNum / AxConstTool.GB;
        }
    }
     ...
     * @return 字节数
     */
    public static long size2Byte(long size, AxConstTool.MemoryUnit unit) {
        if (size < 0) {
            return -1;
        }
        switch (unit) {
            default:
            case BYTE:
                return size * AxConstTool.BYTE;
            case KB:
                return size * AxConstTool.KB;
            case MB:
                return size * AxConstTool.MB;
            case GB:
                return size * AxConstTool.GB;
        }
    }
    ...
    public static ByteArrayOutputStream input2OutputStream(InputStream is) {
        ...
        try {
            ...
            byte[] b = new byte[AxConstTool.KB];
            int len;
            while ((len = is.read(b, 0, AxConstTool.KB)) != -1) {
                os.write(b, 0, len);
            }
            return os;
        } catch (IOException e) {
    ...
    public static String inputStream2String(InputStream is, String charsetName) {
        if (is == null || AxStatusTool.isNullString(charsetName)) {
            return null;
        }
        try {
    ...
    public static OutputStream string2OutputStream(String string, String charsetName) {
        if (string == null || AxStatusTool.isNullString(charsetName)) {
            return null;
        }
        try {
