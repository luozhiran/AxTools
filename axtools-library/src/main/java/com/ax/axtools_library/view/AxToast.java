package com.ax.axtools_library.view;
...
public class AxToast {
    ...
    public static void normal(@NonNull String message) {
        normal(AxTool.getContext(), message, Toast.LENGTH_SHORT, null, false).show();
    }

    public static void normal(@NonNull String message, Drawable icon) {
        normal(AxTool.getContext(), message, Toast.LENGTH_SHORT, icon, true).show();
    }

    public static void normal(@NonNull String message, int duration) {
        normal(AxTool.getContext(), message, duration, null, false).show();
    }

    public static void normal(@NonNull String message, int duration, Drawable icon) {
        normal(AxTool.getContext(), message, duration, icon, true).show();
    }

    public static Toast normal(@NonNull String message, int duration, Drawable icon, boolean withIcon) {
        return custom(AxTool.getContext(), message, icon, DEFAULT_TEXT_COLOR, duration, withIcon);
    }

    public static void warning(@NonNull String message) {
        warning(AxTool.getContext(), message, Toast.LENGTH_SHORT, true).show();
    }

    public static void warning(@NonNull String message, int duration) {
        warning(AxTool.getContext(), message, duration, true).show();
    }

    public static Toast warning(@NonNull String message, int duration, boolean withIcon) {
        return custom(AxTool.getContext(), message, getDrawable(AxTool.getContext(), R.mipmap.ic_error_outline_white_48dp), DEFAULT_TEXT_COLOR, WARNING_COLOR, duration, withIcon, true);
    }

    public static void info(@NonNull String message) {
        info(AxTool.getContext(), message, Toast.LENGTH_SHORT, true).show();
    }

    public static void info(@NonNull String message, int duration) {
        info(AxTool.getContext(), message, duration, true).show();
    }

    public static Toast info(@NonNull String message, int duration, boolean withIcon) {
        return custom(AxTool.getContext(), message, getDrawable(AxTool.getContext(), R.mipmap.ic_info_outline_white_48dp), DEFAULT_TEXT_COLOR, INFO_COLOR, duration, withIcon, true);
    }

    public static void success(@NonNull String message) {
        success(AxTool.getContext(), message, Toast.LENGTH_SHORT, true).show();
    }

    public static void success(@NonNull String message, int duration) {
        success(AxTool.getContext(), message, duration, true).show();
    }

    public static Toast success(@NonNull String message, int duration, boolean withIcon) {
        return custom(AxTool.getContext(), message, getDrawable(AxTool.getContext(), R.mipmap.ic_check_white_48dp), DEFAULT_TEXT_COLOR, SUCCESS_COLOR, duration, withIcon, true);
    }

    public static void error(@NonNull String message) {
        error(AxTool.getContext(), message, Toast.LENGTH_SHORT, true).show();
    }
    ...
    public static void error(@NonNull String message, int duration) {
        error(AxTool.getContext(), message, duration, true).show();
    }

    public static Toast error(@NonNull String message, int duration, boolean withIcon) {
        return custom(AxTool.getContext(), message, getDrawable(AxTool.getContext(), R.mipmap.ic_clear_white_48dp), DEFAULT_TEXT_COLOR, ERROR_COLOR, duration, withIcon, true);
    }
    ...
    public static void showToastShort(String str) {
        Toast.makeText(AxTool.getContext(), str, Toast.LENGTH_SHORT).show();
    }
    ...
    public static void showToastShort(int resId) {
        Toast.makeText(AxTool.getContext(), AxTool.getContext().getString(resId), Toast.LENGTH_SHORT).show();
    }
    ...
    public static void showToastLong(String str) {
        Toast.makeText(AxTool.getContext(), str, Toast.LENGTH_LONG).show();
    }
    ...
    public static void showToastLong(int resId) {
        Toast.makeText(AxTool.getContext(), AxTool.getContext().getString(resId), Toast.LENGTH_LONG).show();
    }
    ...
    public static void showToast(String msg) {
        if (mToast == null) {
            mToast = Toast.makeText(AxTool.getContext(), msg, Toast.LENGTH_LONG);
        } else {
            mToast.setText(msg);
        }
        mToast.show();
    ...
    public static void showToast(int resId) {
        if (mToast == null) {
            mToast = Toast.makeText(AxTool.getContext(), AxTool.getContext().getString(resId), Toast.LENGTH_LONG);
        } else {
            mToast.setText(AxTool.getContext().getString(resId));
        }
        mToast.show();
    }
