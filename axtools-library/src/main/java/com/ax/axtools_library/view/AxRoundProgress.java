 ...
 * 弧形进度条
 */
public class AxRoundProgress extends View {
    ...
    public AxRoundProgress(Context context) {
        this(context, null);
    }

    public AxRoundProgress(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AxRoundProgress(Context context, AttributeSet attrs, int defStyle) {
...
//		canvas.drawRect(0, 0, getWidth(), getWidth(), paint);// 正方形
        ...
        canvas.drawText(AxDataTool.format2Decimals(getProgress() + ""), (centre + 90) - moneyPaint.measureText(AxDataTool.format2Decimals(getProgress() + "")) / 2 - 15, centre + 105, moneyPaint);//右边最大值
        //}
        canvas.drawText("元", (centre + 90) + moneyPaint.measureText(AxDataTool.format2Decimals(getProgress() + "")) / 2 - 10, centre + 105, moneyDPaint);//右边最大值
