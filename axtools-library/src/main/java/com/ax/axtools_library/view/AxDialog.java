...
public class AxDialog extends Dialog{
    ...
    public AxDialog(Context context, int themeResId) {
        super(context, themeResId);
        initView(context);
    }

    public AxDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
        super(context, cancelable, cancelListener);
        initView(context);
    }

    public AxDialog(Context context) {
        super(context);
        initView(context);
    }
     ...
     */
    public AxDialog(Context context, float alpha, int gravity) {
        super(context);
